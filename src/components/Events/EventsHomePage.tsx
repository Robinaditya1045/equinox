...
const events: Event[] = [
  ...
  {
    name: "Infosec",
    bg: "bg-[url('/events/infosec.jpg')]",
    img: "/events/infosec.jpg",
  },
  ...
  {
    name: "Design",
    bg: "bg-[url('/events/design.png')]",
    img: "/events/design.png",
  },
];
...
export default function EventsHomePage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#120303] md:flex md:flex-col md:items-center md:justify-center">
        <div className="min-h-screen flex flex-col items-center justify-center px-4 py-4 lg:py-4 font-atelier">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-8 lg:grid-cols-8 gap-6 md:gap-4 w-full max-w-6xl px-4">
            {events.map((event, index) => (
                ...
                >
                <span className="text-2xl sm:text-3xl md:text-4xl font-semibold text-[#d6a081] px-4 py-2 rounded-md md:rotate-270 ">
                  {event.name}
                </span>
              </div>
            ))}
        ...
        {selectedWing && (
          <div
            ref={eventDetailsRef}
            className="w-full flex flex-row justify-center min-h-screen max-w-6xl mt-12 "
          >
            <EventsDetails
              eventName={selectedWing}
