...
const People: React.FC<PeopleProps> = ({ people, title }) => {  // Destructure props here
    return (
                ...
                {people.map((person) => (
                    <div
                        ...
                        className="flex flex-col items-center justify-center
                            w-full sm:w-20wh md:w-20wh max-w-[400px]
                            transition-transform duration-300 hover:scale-105"
                    >
                        <div
                            className="w-full aspect-square rounded-2xl overflow-hidden
                            shadow-xl hover:shadow-2xl transition-shadow duration-300 relative"
                        >
                            <Image
                                src={person.image}
                                alt={person.name}
